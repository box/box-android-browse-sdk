...
public class NavigationListAdapter extends ArrayAdapter<NavigationItem> {
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        View v = mInflater.inflate(R.layout.boxsdk_navigation_item_folder, parent, false);
        if (v == null) {
            return null;
        }
    ...
    public View getDropDownView(final int position, final View convertView, final ViewGroup parent) {
        ...
        View v = mInflater.inflate(R.layout.boxsdk_navigation_dropdown_item_folder, parent, false);
        if (v == null) {
            return null;
        }
