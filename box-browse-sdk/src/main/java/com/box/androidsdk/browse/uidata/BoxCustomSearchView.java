 ...
 */
public class BoxCustomSearchView extends SearchView {

    private BoxCustomSearchListener mBoxCustomSearchListener;

    public BoxCustomSearchView(final Context context){
        super(context);
        initSearchView(context);
    }

    public BoxCustomSearchView(final Context context, final AttributeSet attrs){
        super(context, attrs);
        initSearchView(context);
    }
