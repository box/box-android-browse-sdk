        ...
        if (boxItem instanceof BoxFolder) {
            ...
            if (boxFolder.getHasCollaborations() == Boolean.TRUE) {
                if (boxFolder.getIsExternallyOwned() == Boolean.TRUE) {
                    return R.drawable.boxsdk_icon_folder_gray_externalcollab;
                }
                return R.drawable.boxsdk_icon_folder_blue_collab;
            }
            return R.drawable.boxsdk_icon_folder_yellow_private;
        }
        else {
            return R.drawable.boxsdk_generic;
        }
    }
